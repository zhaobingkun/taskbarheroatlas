...
if (!existingAtlasSidebar) {
  ...
  if (atlasMain) {
    ...
    sidebar.innerHTML = `
      ...
      <div class="sidebar-status"><span></span><strong>31 PAGE DESK</strong><small>English launch structure<br />Current patch tracked: v1.02.02<br />Official check: Sep 10, 2026</small></div>`;
