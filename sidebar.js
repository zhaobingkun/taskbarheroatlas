...
if (!existingAtlasSidebar) {
  ...
  if (atlasMain) {
    ...
    sidebar.innerHTML = `
      ...
      <div class="sidebar-status"><span></span><strong>31 PAGE DESK</strong><small>English launch structure<br />Current patch tracked: Ver 1.2.4<br />Official check: Sep 18, 2026</small></div>`;
